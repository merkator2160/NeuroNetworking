...
namespace AForge.Controls
{
    ...
    public class Chart : Control
    {
        ...
        // data series table
        Hashtable _seriesTable = new Hashtable();
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            if (_rangeY != null)
            {
                ...
                var en = _seriesTable.GetEnumerator();
                while (en.MoveNext())
                {
        ...
        {
            // get data series
            var series = (DataSeries)_seriesTable[name];
            // update data
            series.Data = data;
