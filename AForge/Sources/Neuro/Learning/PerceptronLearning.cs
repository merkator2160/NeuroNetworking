...
namespace AForge.Neuro.Learning
{
    ...
    public class PerceptronLearning : ISupervisedLearning
    {
        ...
        /// weights in case if neuronBase's output does not equal to the
        ...
        public double Run(double[] input, double[] output)
        {
            ...
            // check output of each neuronBase and update weights
        ...
        /// for each input sample. Updates neuronBase's weights each time,
        /// when neuronBase's output does not equal to the desired output.</remarks>
        /// 
