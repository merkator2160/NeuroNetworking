...
namespace SBUSDecoderCFG
{
    ...
    {
	    private readonly Dictionary<int, ComboBox> cbBankA = new Dictionary<int,ComboBox>();
	    private readonly Dictionary<int, ComboBox> cbBankB = new Dictionary<int, ComboBox>();
	    ...
	    private void update_cbChannelsPPM(ComboBox cb, int FrameIndex, int maxCh)
        {
	    ...
	    private void update_cbChannelsPWM(ComboBox cb, int FrameIndex, int maxCh)
        {
